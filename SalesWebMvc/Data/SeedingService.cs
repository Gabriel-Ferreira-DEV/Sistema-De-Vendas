...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // adiciona varios objetos de uma vez

            _context.Seller.AddRange(s1, s2, s3, s4, s5, s6); // adiciona varios objetos de uma vez

            _context.Sales.AddRange(   // adiciona varios objetos de uma vez
